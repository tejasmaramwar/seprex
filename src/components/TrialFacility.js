      ...
      <>
        <div className="trialfacilitycontainer">
          ...
          <p className="trialfacilitydesc">
            ...
            SEPREX. Equipped with state-of-the-art technology, our pilot plant
            is a proving ground for cutting-edge chemical process engineering.
            Witness firsthand the transformational journey from concept to
            reality, from concept validation to process optimization. See the
            real impact of our work as we translate ideas into reality in the
